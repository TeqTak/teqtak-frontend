        ...
        <div key={index} >
          ...
          <Link to="/userprofile" state={{id:user.Users_PK}} className="flex gap-4">
            <img
              src={user.picUrl}
              alt=""
              className={`h-[50px] w-[50px] rounded-full ${user.role === 'investor' ? 'border-[2px] border-[#FF3434] p-[2px]' : 
    user.role === 'entrepreneur' ? 'border-[2px] border-[#6165F3] p-[2px]' : 'border-[#E6E6E6] border-[2px] p-[2px]'}`}
            />
            <div>
