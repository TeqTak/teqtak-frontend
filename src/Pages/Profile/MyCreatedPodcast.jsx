            ...
            result.speakers.map((elm, ind) => (
              ...
              >
                <img
                  ...
                  className={`rounded-full h-[35px] w-[35px] ${elm.role === 'investor' ? 'border-[3px] border-[#FF3434] p-1' : 
    elm.role === 'entrepreneur' ? 'border-[3px] border-[#6165F3] p-1' : 'border-[#E6E6E6] p-1'}`}
                  alt=""
                />
...
export default MyCreatedPodcast;
