        ...
        <div className="main w-[90%] h-[90%] mx-auto overflow-y-scroll Podcast_Top_Videos">
          <div className="h-full text-[14px] opacity-80">
            <p className="p-2">
              ...
              Teq Tak ("we","us","or","our") collects uses and discloses and
              your informations when you use our mobile applications
              ("the,"app").
            </p>
            ...
            <div className="div p-3">
              <li>
                ...
                name, emailaddress, password, and any other information your
                chose to provide.
              </li>
              <li>
              ...
              <li>
                ...
                app, such as the page you visit, the searches you condect, and
                the feature you use.
              </li>
              <li>
                Device Information: We collect information about the device you
                use to access the app, such as the device type, operating
            ...
            <div className="div p-3">
              ...
              <li>
                Send you important information about the app, such as update and
                security alerts.
              </li>
            ...
            <p>
              ...
              who help us oprate the app. these service providers are
