        ...
        <div className="main w-[90%] h-[90%] mx-auto overflow-y-scroll Podcast_Top_Videos">
          <div className="h-full text-[14px] opacity-80">
            <p>
              ...
              Teq Tak Mobile Application (the "App"). By accessing and using the
              app, you agree to be bound by these terms.
            </p>

            <p className="text-md font-semibold py-3">Who Can Use the App</p>
            <p>
              You must be at least 13 years old to use the app. if your are
              under 18, you must i have your parents or legal guardians
              perimission to use the app.
            </p>
            ...
            <div>
              ...
              <li>
                Interfere with or disrupt the app or the servers or networks
                that support the app.
              </li>
            ...
            <p>
              You retain all ownership rights to the content you post on the
              app. However, by posting content on the app, you grant us a
              non-exclusive, royalty-free, worldwide license to use, display,
              reproduce, modify, and translate you content on the app.
            </p>

            <p className="text-md font-semibold py-3">Termination</p>
            <p>
              We may terminate your access to the app for any reason, at any
              time, without notice. We may also remove any content you post on
              the app for any re
            </p>

            <p className="text-md font-semibold py-3">
              Diclaimer of Warranties
            </p>
            <p>
              The App is Provided "AS IS" And Without Warranties Of Any Kinf,
              Whatover Express Or Implied We Disclaim All Warranties
            </p>
            <br />
          </div>
        </div>
